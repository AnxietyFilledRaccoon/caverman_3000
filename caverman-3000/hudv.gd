...
@onready var label_platita = $Control/LabelPlaitita
...
func _ready():
	...
	GameManager.platita_actualizada.connect(_on_platita_actualizada)
...
func _on_platita_actualizada(platita: int):
	label_platita.text = "$%d" % platita
